defmodule DismoiWeb.Router do
  ...
  scope "/", DismoiWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DismoiWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DismoiWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{DismoiWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", DismoiWeb do
    ...
    live_session :current_user,
      on_mount: [{DismoiWeb.UserAuth, :mount_current_user}] do
